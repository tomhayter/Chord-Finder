...
def findChord():
    ...
    findButton = Button(window, text="Find Chord", width="17", height="2",
                       command=lambda: findFunction())
    
    backButton = Button(window, text="Back", width="17", height="2",
                       command=lambda: mainMenu())
    backButton = menuButtonStyle(backButton, 20)
